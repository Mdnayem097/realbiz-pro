...
const ALL_ROWS = [
  { id: 1, project: "Sheba Eyecon Tower", flatLand: "F 3", customer: "Sagor kumar", totalValue: "10925000", paid: "122320", due: "10802680", installmentDate: "2026-09-03", installmentAmount: "10802680", installmentDue: "10802680", salesBy: "", daysOverdue: "6", delayAmount: "0", nextDueDate: "" },
  { id: 2, project: "Lake Garden", flatLand: "A 12", customer: "Raju Ahmed", totalValue: "8500000", paid: "500000", due: "8000000", installmentDate: "2026-08-15", installmentAmount: "800000", installmentDue: "800000", salesBy: "Karim", daysOverdue: "12", delayAmount: "25000", nextDueDate: "2026-09-15" },
  { id: 3, project: "Green Valley", flatLand: "B 7", customer: "Fatima Begum", totalValue: "6200000", paid: "1200000", due: "5000000", installmentDate: "2026-09-01", installmentAmount: "500000", installmentDue: "500000", salesBy: "Rahim", daysOverdue: "3", delayAmount: "0", nextDueDate: "2026-10-01" },
  { id: 4, project: "Sheba Eyecon Tower", flatLand: "F 8", customer: "Imran Hossain", totalValue: "12500000", paid: "2500000", due: "10000000", installmentDate: "2026-07-20", installmentAmount: "1000000", installmentDue: "1000000", salesBy: "Karim", daysOverdue: "28", delayAmount: "75000", nextDueDate: "2026-09-20" },
  { id: 5, project: "Lake Garden", flatLand: "C 3", customer: "Nusrat Jahan", totalValue: "9800000", paid: "980000", due: "8820000", installmentDate: "2026-09-05", installmentAmount: "882000", installmentDue: "882000", salesBy: "", daysOverdue: "1", delayAmount: "0", nextDueDate: "" },
  { id: 6, project: "Green Valley", flatLand: "D 1", customer: "Kamal Uddin", totalValue: "4500000", paid: "450000", due: "4050000", installmentDate: "2026-08-28", installmentAmount: "405000", installmentDue: "405000", salesBy: "Rahim", daysOverdue: "8", delayAmount: "12000", nextDueDate: "2026-09-28" },
  { id: 7, project: "Sheba Eyecon Tower", flatLand: "G 2", customer: "Shakib Al", totalValue: "15000000", paid: "3000000", due: "12000000", installmentDate: "2026-09-02", installmentAmount: "1200000", installmentDue: "1200000", salesBy: "Karim", daysOverdue: "4", delayAmount: "0", nextDueDate: "2026-10-02" },
  { id: 8, project: "Lake Garden", flatLand: "E 5", customer: "Mitu Akter", totalValue: "7200000", paid: "720000", due: "6480000", installmentDate: "2026-08-10", installmentAmount: "648000", installmentDue: "648000", salesBy: "", daysOverdue: "18", delayAmount: "45000", nextDueDate: "2026-09-10" },
  { id: 9, project: "Green Valley", flatLand: "A 9", customer: "Jamal Khan", totalValue: "5500000", paid: "1100000", due: "4400000", installmentDate: "2026-09-04", installmentAmount: "440000", installmentDue: "440000", salesBy: "Rahim", daysOverdue: "2", delayAmount: "0", nextDueDate: "" },
  { id: 10, project: "Sheba Eyecon Tower", flatLand: "H 1", customer: "Rina Sultana", totalValue: "11200000", paid: "2240000", due: "8960000", installmentDate: "2026-07-15", installmentAmount: "896000", installmentDue: "896000", salesBy: "Karim", daysOverdue: "35", delayAmount: "120000", nextDueDate: "2026-09-15" },
  { id: 11, project: "Lake Garden", flatLand: "B 4", customer: "Tanvir Islam", totalValue: "8900000", paid: "890000", due: "8010000", installmentDate: "2026-09-06", installmentAmount: "801000", installmentDue: "801000", salesBy: "", daysOverdue: "0", delayAmount: "0", nextDueDate: "2026-10-06" },
  { id: 12, project: "Green Valley", flatLand: "C 8", customer: "Sabina Yasmin", totalValue: "6800000", paid: "1360000", due: "5440000", installmentDate: "2026-08-22", installmentAmount: "544000", installmentDue: "544000", salesBy: "Rahim", daysOverdue: "14", delayAmount: "30000", nextDueDate: "2026-09-22" },
];
            ...
            <div className={`flex-1 min-h-0 overflow-x-auto overflow-y-hidden ${hideScroll}`}>
              <table className="w-full text-left text-[12.5px]">
                ...
                <tbody>
                  {pageRows.length === 0 ? (
                    <tr>
                      <td colSpan={15} className="px-2.5 py-10 text-center text-slate-400">
                        No records found
                      </td>
                    </tr>
                  ) : (
                    ...
                    <div className="flex items-start justify-between gap-2">
                      <div className="min-w-0 text-[11px] leading-relaxed">
                        <p className="text-slate-500">
                          Reference: <span className="font-medium text-slate-700">{item.reference}</span>
                        </p>
