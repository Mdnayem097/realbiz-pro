          ...
          {hasChildren ? (
            <button
              ...
              className={clsx(
                ...
                depth === 0 ? "font-semibold text-ink" : "text-ink-muted hover:text-ink hover:bg-canvas"
              )}
            >
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2.5 px-4 h-16 border-b border-border shrink-0">
        <div className="h-8 w-8 shrink-0 rounded-md bg-accent-soft flex items-center justify-center">
          <Building2 size={17} className="text-accent-strong" strokeWidth={2} />
        </div>
        {!collapsed && (
          <span className="font-display font-semibold text-[15px] tracking-tight text-ink truncate">
            RealBiz Pro
          </span>
        )}
      </div>
